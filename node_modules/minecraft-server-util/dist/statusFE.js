...
function statusFE(host, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let maxPlayers = 0;
        {
            ...
            const data = decodeUTF16BE_1.default(String.fromCodePoint(...yield socket.readBytes(length * 2)));
        ...
        return formatResultFE_1.default(host, opts.port, srvRecord, motd, playerCount, maxPlayers);
    });
}
...
exports.statusFE = statusWithTimeout;
